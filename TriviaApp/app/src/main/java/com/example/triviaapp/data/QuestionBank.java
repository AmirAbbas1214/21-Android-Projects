...
import com.example.triviaapp.controller.Appcontrolle;
...
public class QuestionBank {
    ...
    public List<Question>getquestion(AnswerListAsyncResponce callBack){
        ...
        Appcontrolle.getInstance().addToRequestQueue(jsonArrayRequest);
